...
export default function ControlMain({
  ...
  return (
    <>
      <CS.Layout $is_show={isMobileControlShow}>
        <CS.Panel>
          <ControlArea
            map={map}
          ...
          <CS.ToolBox>
            <CS.ToolBoxButton
              ...
              onClick={() => {
                setShowResultMarker(!isShowResultMarker);
              }}
            >
            ...
            <CS.ToolBoxButton
              ...
              onClick={() => {
                setShowResultList(!isShowResultList);
              }}
            >
          ...
          <CS.GameControlLayoutDesktop className="max-desktop:hidden">{GameControl}</CS.GameControlLayoutDesktop>
        </CS.Panel>

        <CS.GameControlLayoutMobile className="desktop:hidden">{GameControl}</CS.GameControlLayoutMobile>
      </CS.Layout>

      <CS.ToggleMobileControl
        $is_show={isMobileControlShow}
        onClick={() => {
          setMobileControlShow(!isMobileControlShow);
        }}
      >
