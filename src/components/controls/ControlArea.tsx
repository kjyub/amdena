    ...
    <CS.ControlBox>
      ...
      <CS.AreaMethodBox>
        <CS.AreaMethodButton
          ...
          onClick={() => {
            handleAreaMethod(AreaMethodTypes.AREA);
          }}
        >
        ...
        <CS.AreaMethodButton
          ...
          onClick={() => {
            handleAreaMethod(AreaMethodTypes.LOCATION);
          }}
        >
      ...
      {areaMethodType === AreaMethodTypes.LOCATION && <ControlAreaSearch map={map} setSelectedArea={setSelectedArea} />}
    </CS.ControlBox>
  );
}
